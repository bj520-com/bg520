  ...
  methods: {
    loadMore() {
      ...
      this.axios.get(url, { params: obj }).then(result => {
        ...
        this.rounter = result.data.data[0];
        this.del = this.rounter.del;
        this.rounter = this.rounter.pics.split(",");
    ...
    //   //console.log(city)
    //   this.rounter = [];
    //   this.axios.get("travel/", { params: { address: city } }).then(result => {
